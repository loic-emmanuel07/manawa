...
export async function createConversation(creatorId: string, participantIds: string[], isGroup: boolean, name?: string) {
  return conversationRepo.createConversation(creatorId, participantIds, isGroup, name);
}